...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1514150155, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "December 2017";
        CTransaction txNew;
        txNew.nTime = 1514150155;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1514150155;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 3438073 : 3438073;
        ...
        assert(block.hashMerkleRoot == uint256("0x51b06039a8b643782342b7b8f9d13a98bdda39f0e244c5cd8293500ea2eaee39"));
...
unsigned char pchMessageStart[4] = { 0xb1, 0x81, 0xe5, 0x60 };
